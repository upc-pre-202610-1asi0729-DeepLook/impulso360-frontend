...
`],encapsulation:2,changeDetection:0})}return a})(),yt=(()=>{class a{static \u0275fac=function(n){return new(n||a)};static \u0275mod=x({type:a});static \u0275inj=f({imports:[U,Z,V]})}return a})();export{yt as a};
